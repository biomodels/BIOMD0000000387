...
`import BIOMD0000000387 as model`
...
**Note:** Model of the Calvin cycle with focus on the RuBisCO reaction by Damour and Urban (2007, [[for PDF click here]](http://algorithmicbotany.org/FSPM07/Individual/15.pdf) ). 

The parameter values are partly taken from Farquhar et al. (1980,
[DOI:10.1007/BF00386231](http://dx.doi.org/10.1007/BF00386231) ) and Urban et
al. (2003,
[DOI:10.1093/treephys/23.5.289](http://dx.doi.org/10.1093/treephys/23.5.289)
